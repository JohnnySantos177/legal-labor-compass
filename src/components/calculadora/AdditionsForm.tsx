...
export const AdditionsForm = ({ additions, onAdd, onRemove, onToggle }: AdditionsFormProps) => {
  ...
  return (
    <Card className="juriscalc-card">
      <CardHeader>
        <CardTitle className="text-juriscalc-navy">Adicionais</CardTitle>
      </CardHeader>
      <CardContent className="space-y-6">
        {/* Preset Additions */}
        <div>
          <h4 className="font-medium text-juriscalc-navy mb-3">Adicionais Pré-definidos</h4>
        ...
        <div className="border-t pt-4">
          <h4 className="font-medium text-juriscalc-navy mb-3">Adicional Personalizado</h4>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            <div className="md:col-span-2">
              <Label htmlFor="additionName" className="juriscalc-label">Nome</Label>
              <Input
                id="additionName"
            ...
            <div>
              <Label className="juriscalc-label">Tipo</Label>
              <Select 
            ...
            <div>
              <Label htmlFor="additionValue" className="juriscalc-label">
              ...
              <div className="flex">
                <Input
                  ...
                  className="juriscalc-input"
                />
                <Button onClick={handleAdd} className="ml-2 bg-juriscalc-blue hover:bg-juriscalc-navy">
        ...
        {additions.length > 0 && (
          <div className="border-t pt-4">
            <h4 className="font-medium text-juriscalc-navy mb-3">Adicionais Selecionados</h4>
